"""
Django settings for hktblog project.
...
SECRET_KEY = '8(6j#6j@rvr#zqg@5@8+(yx64x8d2*x*sfu@+!p*b59$uwbl9t'
...
WSGI_APPLICATION = 'hktblog.wsgi.application'
